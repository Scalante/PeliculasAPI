    ...
    public partial class PeliculasActoresPeliculasGeneros : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PeliculasActores", x => new { x.GeneroId, x.PeliculaId });
                    table.ForeignKey(
                        name: "FK_PeliculasActores_Generos_GeneroId",
                        column: x => x.GeneroId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PeliculasGeneros", x => new { x.ActorId, x.PeliculaId });
                    table.ForeignKey(
